...
namespace EpinelPS.LobbyServer.Outpost
{
    ...
    public class StartSuddenEvent : LobbyMsgHandler
    {
        protected override async Task HandleAsync()
        {
            ...
            if (GameData.Instance.OutpostConditionTriggerTable.TryGetValue(req.Tid, out OutpostConditionTriggerRecord? trigger))
            {
                response.Reward = RewardUtils.RegisterRewardsForUser(user, trigger.RewardId);
            }
